...
/**
  ...
  */
class OSReport extends JobComputing {
  ...
  override def process(): Unit = {
    ...
    resultDF.repartition(1).write.mode(SaveMode.Append).json(ReportConstant.OS_SINK_JSON_PATH)
